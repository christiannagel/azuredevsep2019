...
namespace myworker
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("myworker is running");
        ...
        public override bool OnStart()
        {
            ...
            Trace.TraceInformation("myworker has been started");
        ...
        {
            Trace.TraceInformation("myworker is stopping");
            ...
            Trace.TraceInformation("myworker has stopped");
        }
