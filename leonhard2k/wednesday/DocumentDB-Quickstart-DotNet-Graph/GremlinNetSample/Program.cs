...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static string hostname = "gremlindbazure.gremlin.cosmosdb.azure.com";
        private static int port = 443;
        private static string authKey = "KTbiKpyfZjgfCxccg3OqcWEZBBBvH08VFwdGVpTSX0GcEvke9YcwU1lfGiLPph7BptXlQIJyHQ9aEW1mdnQWwQ==";
